...
# 2023.11.29
昨日は時間取れなかったので、単一テーブル継承のまとめをやる。

OKできた。次はどっちにしよう。正体わかってる`transient`と`after`からいこうかな。

よし、残るは`=>`のみ。これだけマジで謎なんだよなあ。どうしてもわからなければ質問とか技術面談かな。

あ〜〜〜わかった！やっぱりスペースだ！行末のスペース！  
`==>`に触れてる記事を見つけて、そこに公式のREADMEが参考として載ってたから探しながら見たらたしかに載ってた。ロボらんてくんはこれわかんなかったかあ。やっぱり過信しちゃいかんね。  
なるほど〜だから一番最後（右端）にくるタイトル検索フィールドはただの`=`なんだ。  
[公式README](https://github.com/slim-template/slim/blob/main/README.jp.md)  
[参考記事](http://cojirooo777.blog.fc2.com/blog-entry-33.html)

よし、復習完了。カリキュラムは一旦ここまでにして、今日この後は途中になってたワークの続きをやろう。